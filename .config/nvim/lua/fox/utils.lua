local config = require "fox.config"
local constants = require "fox.constants"
local date = require "fox.date"
local gh = require "fox.glab"
...
function M.get_pages(text)
  local results = {}
  -- TODO: this is a hack to fix the glab response concatenation
